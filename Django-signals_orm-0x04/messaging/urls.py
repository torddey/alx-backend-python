...
from .views import (
    ...
    create_new_thread, get_user_id, unread_messages, unread_messages_with_unread_for_user,
    unread_messages_optimized, unread_messages_summary, mark_messages_as_read
)

urlpatterns = [
    path('messages/', message_list, name='message_list'),
    path('unread/', unread_messages, name='unread_messages'),
    path('unread/unread-for-user/', unread_messages_with_unread_for_user, name='unread_messages_with_unread_for_user'),
